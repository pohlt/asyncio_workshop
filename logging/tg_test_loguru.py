...
# logger = logger.patch(lambda record: record["extra"].update(task_name=get_task_name()))
# print(dir(logger._core.handlers[0]))
# print(dir(logger._core.handlers[0]._formatter))
logger.remove(0)
